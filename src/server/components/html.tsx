...
const Html: React.SFC<IProps> = ({ scripts = [], children, app, state }) => (
  <html>
    <head>
      ...
      <style
      >{`html{box-sizing:border-box;background-color:#f6f6ef}*,*:before,*:after{box-sizing: inherit}body{margin:0;font-family:sans-serif}a{color:#000;overflow-wrap:break-word}.comment pre{white-space:pre-wrap;}`}</style>
    </head>
    <body>
